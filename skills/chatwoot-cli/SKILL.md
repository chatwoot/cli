...
```bash
chatwoot hcs -o json
chatwoot hc default user-guide
chatwoot hc articles --query "api channel" -o json
chatwoot hc articles --category channels -o json
chatwoot hc article 1677839703-how-to-create-an-api-channel-inbox -o json
```
